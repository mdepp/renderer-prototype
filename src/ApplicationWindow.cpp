...
app::SDLException::SDLException(const std::string &message) {
    m_message = message + std::string(": ") + SDL_GetError();
}

const char *app::SDLException::what() const noexcept {
